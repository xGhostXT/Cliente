...
namespace pSC08
{
    public partial class frmMVTOCTE : Form
    {
        ...
        {
            this.Text = "Movimientos de Cliente";
        ...
        private void textBox1_Leave(object sender, KeyPressEventArgs e)
        {
        ...
        private void BuscarData(string numCte)
        {
            ...
            while (rcd.Read())
            {
                ...
                dgv[06, xRows].Value = Convert.ToString(rcd["Quanity"]);
                ...
                sCol01 = sCol01 + Convert.ToDouble(rcd["Descuento"]);
                sCol02 = sCol02 + Convert.ToDouble(rcd["Descuento"]);
                sCol03 = sCol03 + Convert.ToDouble(rcd["Descuento"]);


            }

            lblCOL01.Text = sCol01.ToString();
            lblCOL02.Text = sCol02.ToString();
            lblCOL03.Text = sCol03.ToString();
        ...
        private void frmMVTOCTE_Size(object sender, EventArgs e)
        {
